    ...
    <div className='h-16 px-3 flex justify-between w-full items-center bg-white'>
      ...
      <div className='flex items-center gap-2 pr-2'>
            ...
            return <>
              ...
              >
                <Popover.Panel className='absolute -right-3 w-60'>
                  <div className='bg-white round-sm'>
        ...
        <Menu as='div' className='relative inline-block text-left'>
          ...
          <Menu.Items className='origin-top-right z-10 absolute right-0 mt-2 w-48 bg-white rounded-sm ring-black ring-1ring-opacity-5 focus: bg-gray-200'>
            <Menu.Item as='div'>
              {({active}) => {
